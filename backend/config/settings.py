...
MIDDLEWARE = [
    ...
    # LocaleMiddleware renders the admin dashboard in Persian (RTL).
...
# The admin dashboard is shown in Persian with a right-to-left layout.
# (Posts themselves can still be written in English or Persian — that is
# controlled per-post by the "language" field, not by this setting.)
LANGUAGE_CODE = "fa-ir"
...
# Frontend dev servers (Vite default is 5173).
